...
func TestOutput(t *testing.T) {
	log := New("testComponent", "testPackage", "/dev/null")
	...
	expected := "[INFO]  testComponent: " + testString + "\n"
...
func TestOutputf(t *testing.T) {
	...
	expected := "[INFO]  testComponent: testy test\n"
...
func TestLogFile(t *testing.T) {
	...
	log := New("testComponent", "testPackage", "/tmp/pfsLogTest")
	log.SetOutput("both")
	...
	log.Info(testString)
	data, _ := ioutil.ReadFile("/tmp/pfsLogTest/testPackage.log")
